...
### ▼ `vec2 uv = gl_FragCoord.xy / u_resolution.xy;`
何番目のピクセルにいるかを意味する `gl_FragCoord.xy` を解像度で割った値を保持しています．この後，この値を用いてピクセルごとの色を決めています．
...
<p class="text-right">
参照URL: <a href="https://twigl.app" target="_blank" noreferrer>twigl.app</a>
</p>
