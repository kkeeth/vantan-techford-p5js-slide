...
lineNumbers: true
info: |
  ## クリエイティブコーディング（JavaScript）講義資料#1
...
drawings:
  persist: false
layout: intro
title: クリエイティブコーディング（JavaScript）講義
---

# クリエイティブコーディング（JavaScript）講義
...
この講義の最終目標は、`JavaScript` をベースとしたクリエイティブコーディング要ライブラリ __p5.js__ を利用し，プログラミングをすることでオリジナルな絵やアニメーションを描けるようになることです．
<br>
<br>
