...
| <kbd>3</kbd> | JavaScript 基礎②/p5.js基礎② | p5.js のアニメーション，ランダム関数 |
...
| <kbd>11</kbd> | JavaScript 基礎③ | クラス・インスタンス |
| <kbd>12</kbd> | 各種イベント処理，フォーム | マウス・キーボードと連動させる，フォームを導入 |
| <kbd>13</kbd> | 複雑な図形を描く | `Vertex` メソッドを用いて桜を描く |
| <kbd>14</kbd> | イージング基礎，lerp() メソッド | イージング, leap() でアニメーション |
| <kbd>15</kbd> | 作品発表会，クロージング | 最終課題で各自で作ってきた作品をフィードバックし合う |
