...
| 日程 | テーマ | 講義アジェンダ |
| --- | --- | --- |
| <kbd>15</kbd> | ライブラリを利用 | 様々な p5.js 周りのライブラリに触れてみる|
| <kbd>16</kbd> | GLSL 入門① | GLSL，シェーダーとは，Ripple アニメーションを実装 |
| <kbd>17</kbd> | GLSL 入門② | つぶやきGLSL のコードをいくつか解析・写経してみよう |
| <kbd>18</kbd> | いくつかの作品のコードリーディング③ | 色々学んだ知識を生かして，コードをトレースしてみましょう |
| <kbd>19</kbd> | 最終課題発表ともくもく会 | 最終課題の説明/残り時間もくもく会 |
