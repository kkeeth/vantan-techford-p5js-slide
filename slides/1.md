...
| <kbd>10</kbd> | 3D，WEBGL 基礎 | p5.js における 3D の絵，アニメーションはどう描くのか |
| <kbd>11</kbd> | 各種イベント処理 | マウス・キーボードと連動させる |
| <kbd>12</kbd> | JavaScript 基礎③ | オブジェクト，クラス，インスタンス |
| <kbd>13</kbd> | オブジェクトごとに状態をもたせる | 各オブジェクトにそれぞれ固有の状態と動きをさせる |
| <kbd>14</kbd> | 複雑な図形を描く | `Vertex` という機能を使って様々な図形を描いてみる |
...
| 日程 | テーマ | 講義アジェンダ |
| --- | --- | --- |
| <kbd>15</kbd> | いくつか簡単な絵を作ってみる | 桑原の過去作品やインターネットに公開されているものを題材に |
| <kbd>16</kbd> | TBD | TBD |
| <kbd>17</kbd> | TBD | TBD |
