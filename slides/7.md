...
### #7 数学基礎③<br />（三角関数の続き/三角関数を応用してアニメーション） + p5.js
...
<img src="/assets/7/tri-func1.png" alt="三角関数を円で図示" width="600" class="mx-auto mt-10" />
...
<img src="/assets/7/poler-coordinates.png" alt="極座標の図示" width="600" class="mx-auto mt-5" />
